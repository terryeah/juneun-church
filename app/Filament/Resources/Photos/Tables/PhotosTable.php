    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                 ...
                 *
                 * A star means the photograph is on the front page. The
                 * album's own 활성화 no longer qualifies that: it decides
                 * whether the album is listed on 앨범, and the band asks
                 * only about this box.
                 */
                IconColumn::make('featured_in_slider')
                    ->label('홈 슬라이더')
                    ->icon(fn (Photo $record): ?Heroicon => $record->featured_in_slider ? Heroicon::Star : null)
                    ->color('warning'),
