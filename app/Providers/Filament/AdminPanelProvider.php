    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->renderHook(
                ...
                fn (): HtmlString => new HtmlString('<style>.fi-sidebar-nav a[href$="/admin/photos"]{margin-inline-start:0.875rem}.fi-sidebar-nav a[href$="/admin/staff-members"]{margin-inline-start:0.875rem}.fi-sidebar-nav a[href$="/admin/users"]{margin-inline-start:0.875rem}.fi-sidebar-nav a[href$="/admin/ministries"]{margin-inline-start:1.75rem}.fi-sidebar-nav a[href$="/admin/positions"]{margin-inline-start:2.625rem}.fi-fo-file-upload .filepond--root{min-height:13rem}.fi-fo-file-upload .filepond--drop-label{min-height:13rem}.fi-fo-rich-editor-content{min-height:7.7rem}.fi-one-time-code-input-ctn{width:100%;justify-content:center}.fi-one-time-code-input-ctn .fi-one-time-code-input-digit{flex:1 1 0;min-width:0;max-width:3.75rem;height:3.5rem;font-size:1.25rem;text-align:center}@media (max-width:39.9375rem){.fi-ta-table-stacked-on-mobile>tbody>tr{padding-block:1rem}.fi-ta-table-stacked-on-mobile>tbody>tr>.fi-ta-cell{padding-block:.3rem}.fi-ta-table-stacked-on-mobile .fi-ta-cell-label{padding-top:0;font-size:.7rem;line-height:1.2;letter-spacing:.03em;text-transform:uppercase;opacity:.75}.fi-ta-table-stacked-on-mobile .fi-ta-cell-content{line-height:1.45;min-height:1.3rem}.fi-ta-table-stacked-on-mobile .fi-ta-actions{justify-content:flex-end}}@media (min-width:24rem) and (max-width:39.9375rem){.fi-ta-table-stacked-on-mobile>tbody>tr:not(.fi-ta-group-header-row):not(.fi-ta-summary-row){display:grid;grid-template-columns:repeat(2,minmax(0,1fr));column-gap:1.25rem;row-gap:.55rem;align-items:start}.fi-ta-table-stacked-on-mobile>tbody>tr>.fi-ta-cell{padding-block:0}.fi-ta-table-stacked-on-mobile>tbody>tr>.fi-ta-cell.stacked-span-full,.fi-ta-table-stacked-on-mobile>tbody>tr>.fi-ta-cell:has(>.fi-ta-actions),.fi-ta-table-stacked-on-mobile>tbody>tr>.fi-ta-cell:has(.fi-ta-record-checkbox){grid-column:1/-1}.fi-ta-table-stacked-on-mobile>tbody>tr>.fi-ta-cell:has(>.fi-ta-actions){margin-top:.35rem;border-top:1px solid rgba(128,138,160,.18);padding-top:.6rem}}</style>'),
            )
            ->colors([
                'primary' => Color::Amber,
            ])
