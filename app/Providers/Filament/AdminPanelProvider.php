    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->renderHook(
                ...
                fn (): HtmlString => new HtmlString('<style>.fi-sidebar-nav a[href$="/admin/photos"]{margin-inline-start:1.75rem}.fi-fo-file-upload .filepond--root{min-height:13rem}.fi-fo-file-upload .filepond--drop-label{min-height:13rem}.fi-fo-rich-editor-content{min-height:15.5rem}</style>'),
            )
            ->colors([
                'primary' => Color::Amber,
            ])
