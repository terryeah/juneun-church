...
class AdminPanelProvider extends PanelProvider
{
    ...
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            /** The church mark beside the name, in place of the name alone. */
            ->brandLogo(fn (): View => view('filament.brand'))
            /** Room for the mark, which stands taller than the name beside it. */
            ->brandLogoHeight('1.75rem')
            ->subNavigationPosition(SubNavigationPosition::Top)
            ->navigation(fn (NavigationBuilder $builder): NavigationBuilder => static::buildNavigation($builder))
            ->renderHook(
                PanelsRenderHook::HEAD_END,
                fn (): HtmlString => new HtmlString('<style>'.static::panelStyles().'</style>'),
            )
            ->renderHook(
    ...
    protected static function buildNavigation(NavigationBuilder $builder): NavigationBuilder
    {
        return $builder->groups([
            ...
            /**
             * 교적 is the church's register of people; 계정 is who can
             * sign in to the website. They were one group, which read
             * as though a login were part of a person's membership -
             * and the two genuinely come apart: someone on the register
             * may have no account, and an account may belong to someone
             * the register has not caught up with.
             */
            NavigationGroup::make('교적')->items([
