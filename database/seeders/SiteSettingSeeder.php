...
class SiteSettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'address_main', 'value' => '24 Levington Rd, Eight Mile Plains QLD 4113', 'group' => 'contact'],
            ...
            ['key' => 'sunday_service_time', 'value' => '주일 오전 11:30', 'group' => 'service_times'],
            ['key' => 'sunday_service_venue', 'value' => '본당', 'group' => 'service_times'],
            ['key' => 'wednesday_service_name', 'value' => '수요예배', 'group' => 'service_times'],
            ['key' => 'wednesday_service_time', 'value' => '수요일 오후 7:30', 'group' => 'service_times'],
            ['key' => 'wednesday_service_venue', 'value' => '본당', 'group' => 'service_times'],
            ['key' => 'kids_service_name', 'value' => '주일학교', 'group' => 'service_times'],
            ['key' => 'kids_service_time', 'value' => '주일 오전 11:30', 'group' => 'service_times'],
            ['key' => 'kids_service_venue', 'value' => '교육관', 'group' => 'service_times'],

            ['key' => 'instagram_url', 'value' => 'https://www.instagram.com/', 'group' => 'social'],
            ['key' => 'youtube_url', 'value' => 'https://www.youtube.com/', 'group' => 'social'],
