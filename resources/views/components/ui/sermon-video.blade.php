...
>
    ...
    <span class="absolute inset-0 flex items-center justify-center">
        <span class="flex h-[3.625rem] w-[3.625rem] items-center justify-center rounded-play bg-accent text-on-accent transition-colors duration-300 group-hover:bg-accent-700">
