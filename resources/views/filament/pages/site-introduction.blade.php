<x-filament-panels::page>
    ...
    <div class="intro">
        ...
        <section class="intro-band intro-band-soft intro-reveal">
            ...
            <ol class="intro-next">
                <li>
                    <div><h3 class="intro-h3">실제 주보 올리기</h3>
                    <p>지금 올라가 있는 한 건은 시험용 파일입니다. 실제 주보를 올리면 매주 쌓이기 시작합니다.</p></div>
                </li>
                <li>
                    <div><h3 class="intro-h3">교회 이메일과 구글 계정</h3>
                    <p>juneun.com 주소로 교회 이메일을 만들 수 있습니다. 등록 비영리단체는 구글 업무용 계정을 무료로 쓸 수 있어,
                        유튜브 채널과 통계도 개인 계정이 아닌 교회 소유로 옮길 수 있습니다.</p></div>
                </li>
                <li>
                    <div><h3 class="intro-h3">구글 지도 등록</h3>
                    <p>"브리즈번 한인교회"를 검색했을 때 지도와 함께 뜨려면 교회 명의의 등록이 필요합니다.
                        새로 오시는 분이 교회를 찾는 가장 큰 통로입니다.</p></div>
                </li>
                <li>
                    <div><h3 class="intro-h3">성도들께 안내</h3>
                    <p>헌금 내역을 보시려면 홈페이지에서 가입 신청을 하셔야 합니다.
                        광고 시간에 한 번 알려 주시면 신청이 들어오기 시작합니다.</p></div>
                </li>
            </ol>
        </section>
