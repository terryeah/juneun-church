    ...
    <div class="wiki">
        ...
        <details class="wiki-part" open>
            ...
            <div class="wiki-body">
                ...
                <article class="wiki-task">
                    ...
                    <p class="wiki-note">헌금 페이지에서 <b>로그인한 성도에게만</b> 보입니다. 지난 12주까지 넘겨볼 수 있습니다. 재정 담당 역할을 받은 분은 이 메뉴만 보입니다.</p>
                </article>
        ...
        <details class="wiki-part">
            ...
            <div class="wiki-body">
                ...
                <p class="wiki-lede">성도 전용을 켜면 <b>로그인하지 않은 사람의 화면에서 아예 빠집니다.</b> 가려 놓는 것이 아니라 목록에서 빠지기 때문에, 제목도 파일 주소도 나가지 않습니다.</p>
                ...
                <p class="wiki-warn"><b>홈 화면 슬라이더는 성도 전용과 상관없이 동작합니다.</b> 성도 전용 앨범 안의 사진이라도 <b>홈 슬라이더에 표시</b>를 켜면 홈 화면에 나옵니다. 사진 한 장을 고르는 것은 앨범 전체와 별개라고 보기 때문입니다. 눌러도 앨범으로는 못 들어가고 갤러리 목록으로 갑니다.</p>
                <p class="wiki-note"><b>성도 전용 링크를 받은 분이 "페이지가 없다"고 합니다.</b> 정상입니다. "로그인하세요"라고 하면 그 주소에 무언가 있다는 것을 알려주는 셈이라, 아예 없는 것처럼 처리합니다. 로그인하시면 바로 보입니다.</p>
        ...
        <details class="wiki-part">
            ...
            <div class="wiki-body">
                ...
                <div class="wiki-qa">
                    ...
                    <p class="wiki-a"><b>활성화</b>가 꺼져 있을 가능성이 큽니다. 앨범 목록에서 바로 켤 수 있습니다. 켰는데도 안 보이면 <b>성도 전용</b>이 켜져 있는지 보세요 &mdash; 그러면 로그인한 사람에게만 보입니다.</p>
                </div>
