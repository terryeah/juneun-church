    ...
    <div class="wiki">
        ...
        <details class="wiki-part">
            ...
            <div class="wiki-body">
                ...
                <p class="wiki-note"><b>성도 전용 링크를 받은 분이 "페이지가 없다"고 합니다.</b> 정상입니다. "로그인하세요"라고 하면 그 주소에 무언가 있다는 것을 알려주는 셈이라, 아예 없는 것처럼 처리합니다. 로그인하시면 바로 보입니다 &mdash; 다만 <b>교적에 계신 분만</b> 그렇습니다. 로그인해도 계속 안 보인다면 그분이 교적에 없는 것이니, <b>교적 &rsaquo; 성도</b>에서 확인해 주세요.</p>
